...
namespace LiaoTian_Cup
{
    ...
    public partial class ShowDoublesDetail : Page
    {
        ...
        private void showSelect()
        {
            ...
            string BaseFactor1_name = (HasSelectBaseFactor1.Source as BitmapImage).UriSource.ToString().Replace("/LiaoTian_Cup;component/Resources/factor/", "").Replace(".png", "");
            HasSelectBaseFactor1_index.Content = FileData.mutator_index_dict[BaseFactor1_name];
            string BaseFactor2_name = (HasSelectBaseFactor2.Source as BitmapImage).UriSource.ToString().Replace("/LiaoTian_Cup;component/Resources/factor/", "").Replace(".png", "");
            ...
            {
                string BaseFactor3_name = (HasSelectBaseFactor3.Source as BitmapImage).UriSource.ToString().Replace("/LiaoTian_Cup;component/Resources/factor/", "").Replace(".png", "");
                HasSelectBaseFactor3_index.Content = FileData.mutator_index_dict[BaseFactor3_name];
            }

            string fixed_mutator_name = (FixedMutator1.Source as BitmapImage).UriSource.ToString().Replace("/LiaoTian_Cup;component/Resources/factor/", "").Replace(".png", "");
            ...
            {
                string HasSelectFactor3_name = (HasSelectFactor3.Source as BitmapImage).UriSource.ToString().Replace("/LiaoTian_Cup;component/Resources/factor/", "").Replace(".png", "");
